...
echo "1.1.1.x Set 'Antivirus on the machine'" 
echo "check the antivirus on the machine" >> audit.txt
...
$a += if ($b -match "Defender") {echo "compliance"} else {echo "defender not installed"}
write-output $a
